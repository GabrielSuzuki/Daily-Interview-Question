...
#all values in the left subtree are less than or equal to the root, and all values in the right subtree are greater than or equal to the root.
...
def is_bst(root):
  ...
  #check if the right is more than the root
  if(root.left != None):
